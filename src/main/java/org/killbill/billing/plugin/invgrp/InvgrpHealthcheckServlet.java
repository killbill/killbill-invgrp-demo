...
@Singleton
@Path("/healthcheck")
public class InvgrpHealthcheckServlet extends PluginHealthcheck {

    private final InvgrpHealthcheck healthcheck;

    @Inject
    public InvgrpHealthcheckServlet(final InvgrpHealthcheck healthcheck) {
